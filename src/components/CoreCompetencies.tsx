          ...
          {isLoading
            ? Array(8)
                ...
                .map((_, index) => (
                  <div
                    key={`shimmer-${index}`}
                    className="glass-effect rounded-xl p-6 shimmer-dark"
                  >
                    <div className="text-center space-y-4">
                      <div className="inline-flex w-16 h-16 rounded-full bg-white/10 mx-auto" />
                      <div className="h-4 bg-white/10 rounded w-3/4 mx-auto" />
                      <div className="h-3 bg-white/10 rounded w-full mx-auto" />
                    </div>
                  </div>
                ))
